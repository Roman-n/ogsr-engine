...
void SetupExceptionHandler	(const bool &dedicated)
{
	...
	BT_SetDialogMessage				(
		BTDM_INTRO2,
		"\
В процессе игры произошла ошибка. Лог, дамп и скриншот экрана сохранены в архиве в папке логов.\
Опционально можете сохранить его, где вам угодно, нажав кнопку Save. Заслать архив разработчикам\
можно, нажав кнопку Submit Bug."
	);
