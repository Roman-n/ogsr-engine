...
void 	PDomain::FillProp	(PropItemVec& items, LPCSTR pref, u32 clr)
{
    ...
    case vNum:
        switch(type){
            case PDPoint:                           
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Center"), 		&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
            case PDLine:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Point 1"), 	&v[0],flt_min,flt_max,0.001f,4); 	V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Point 2"), 	&v[1],flt_min,flt_max,0.001f,4);	V->Owner()->prop_color	= TColor(clr);
                break;
            case PDTriangle:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Vertex 1"), 	&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Vertex 2"), 	&v[1],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Vertex 3"), 	&v[2],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
            case PDPlane:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Origin"),	 	&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Normal"), 	 	&v[1],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
            case PDBox:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Min"),		 	&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Max"), 	 		&v[1],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
            case PDSphere:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Center"),	 	&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateFloat  	(items,PrepareKey(pref,"Radius Inner"),	&f[3],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateFloat	(items,PrepareKey(pref,"Radius Outer"),	&f[4],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
            case PDCylinder:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Point 1"),	 	&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Point 2"),	 	&v[1],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateFloat  	(items,PrepareKey(pref,"Radius Inner"),	&f[6],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateFloat  	(items,PrepareKey(pref,"Radius Outer"),	&f[7],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
            case PDCone:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Apex"),	 		&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"End Point"),	&v[1],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateFloat  	(items,PrepareKey(pref,"Radius Inner"),	&f[6],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateFloat  	(items,PrepareKey(pref,"Radius Outer"),	&f[7],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
            case PDBlob:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Center"),	 	&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateFloat	(items,PrepareKey(pref,"Radius Outer"),	&f[3],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
            case PDDisc:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Center"),	 	&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Normal"),	 	&v[1],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
            ...
            case PDRectangle:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Origin"),	 	&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Basis U"),	 	&v[1],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Basis V"),	 	&v[2],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
            default:
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Translate"),	&v[0],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Rotate"),	 	&v[1],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                V=PHelper().CreateVector	(items,PrepareKey(pref,"Scale"),	 	&v[2],flt_min,flt_max,0.001f,4);V->Owner()->prop_color	= TColor(clr);
                break;
        }
    break;
    case vAngle:
