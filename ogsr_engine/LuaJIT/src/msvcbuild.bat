...
@set ALL_LIB=lib_base.c lib_math.c lib_bit.c lib_string.c lib_table.c lib_io.c lib_os.c lib_package.c lib_debug.c lib_jit.c lib_ffi.c lib_lfs.c lib_xml.c
...
@del X:\ogsr_package\READY\bin\jit\* /q
@XCOPY jit\* "X:\ogsr_package\READY\bin\jit\" /y/i
@echo.
